...
<!-- Bootstrap core javascript-->
    ...
    <script integrity="" src="<?php echo get_stylesheet_directory_uri(); ?>/js/library/jquery-3.3.1.slim.min.js" crossorigin="anonymous"></script>
    ...
    <script integrity="" src="<?php echo get_stylesheet_directory_uri(); ?>/js/main.js" crossorigin="anonymous"></script>

    <script integrity="" src="<?php echo get_stylesheet_directory_uri(); ?>/js/skip-link-focus-fix.js" crossorigin="anonymous"></script>

        <script integrity="" src="<?php echo get_stylesheet_directory_uri(); ?>/js/video-player.js" crossorigin="anonymous"></script>
    <script async> 
